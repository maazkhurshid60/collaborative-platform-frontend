const VerifiedRibbonBadge = () => {
  return (
    <div className="relative inline-block text-center">
      ...
      <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-green-600 w-3 h-5 rotate-45 origin-top-left" />
      <div className="absolute -bottom-3 right-1/2 transform translate-x-1/2 bg-green-600 w-3 h-5 -rotate-45 origin-top-right" />
