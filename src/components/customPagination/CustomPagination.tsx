          ...
          <li>
            <div className="relative group">
              <RiArrowLeftSLine
                ...
                className={`flex items-center justify-center bg-transparent rotate-180  leading-tight rounded-s-lg hover:bg-primaryColor hover:text-primaryColorDark font-inter text-[13px] ${currentPage === totalPages ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}
              />
