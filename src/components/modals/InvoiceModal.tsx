  ...
  const invoice = React.useMemo(() => {
    return (
      invoiceData || {
        ...
        total: "$49.00",
        notes:
          "Thank you for your business! Your subscription will automatically renew on March 15, 2025. If you have any questions about this invoice, please contact our support team.",
      }
    );
          ...
          <div className="p-5 bg-white">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex flex-col gap-1">
                <img
                  src={logo}
                  alt="Kolabme"
                  className="h-15 w-fit object-contain mb-1"
                />
                <div
                  className="text-xs font-normal font-[Poppins] space-y-0.5"
                  style={{ color: "#6b7280" }}
                >
              ...
              <div className="text-right">
                ...
                <div
                  className="text-[10px] font-normal font-[Poppins] space-y-0.5"
                  style={{ color: "#4b5563" }}
                >
                  <p>
            ...
            <div className="mb-4">
              ...
              <div className="text-[11px]" style={{ color: "#4b5563" }}>
                ...
                <p>
                  {invoice.billTo.address} {invoice.billTo.city}
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#F9FAFB] rounded-lg p-4 mb-4">
              <div
                className="grid grid-cols-12 gap-2 text-[10px] items-center font-bold mb-2 pb-2 border-b px-2"
              ...
              {invoice.items.map((item: any, id: number) => (
                <div
                  key={id}
                  className="grid grid-cols-12 gap-2 text-[10px] items-center py-2 px-2"
                  style={{ color: "#4b5563" }}
                >
                  ...
                  <div className="col-span-2 flex justify-center font-medium">
                    {item.qty}
                  </div>
                  ...
                  <div
                    className="col-span-2 flex justify-center font-medium"
                    style={{ color: "#111827" }}
                  >
                    {item.amount}
                  </div>
            ...
            <div className="text-[10px]" style={{ color: "#4b5563" }}>
              <h4 className="font-bold mb-1" style={{ color: "#111827" }}>
                Notes:
              </h4>
