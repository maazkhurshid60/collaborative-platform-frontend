...
const CancelSubscriptionModalBody: React.FC<CancelSubscriptionModalProps> = ({
  onClose,
}) => {
    ...
    try {
      ...
      if (userDetails?.user?.id && userDetails?.user?.role) {
        ...
        try {
          ...
          console.error(
            "Failed to refresh user data after cancellation:",
            refreshError,
          );
        } finally {
  ...
  return (
    <div className="flex flex-col items-center text-center p-2">
        ...
        <defs>
          ...
          >
            ...
            <feBlend
              ...
              result="effect1_dropShadow_2662_2095"
            />
            <feBlend
              mode="normal"
              in="SourceGraphic"
              in2="effect1_dropShadow_2662_2095"
              result="shape"
            />
          </filter>
          <linearGradient
            id="paint0_linear_2662_2095"
            x1="57.9499"
            y1="0"
            x2="57.9499"
            y2="115.9"
      ...
      <h2 className="text-[24px] font-bold text-[#101828] mb-3 mt-3 font-[Poppins]">
        Cancel Subscription
      </h2>

      <p className="text-[16px] text-[#666666] mb-8 max-w-100 leading-relaxed font-[Poppins]">
        Your feedback helps us improve. Before you leave, would you mind sharing
        why you're cancelling?
      </p>

      <div className="w-full text-left mb-8">
        <label className="block text-[14px] font-medium text-[#101828] mb-2 font-[Poppins]">
          Select a Reason
        </label>
        <div className="relative">
          <select
            ...
            disabled={isLoading}
            className="w-full bg-[#F2F4F7] border-none rounded-lg p-4 pr-10 text-[16px] text-[#666666] appearance-none focus:outline-none focus:ring-2 focus:ring-[#2C9993]/20 font-[Poppins] cursor-pointer"
          >
...
const CancelSubscriptionModal: React.FC<CancelSubscriptionModalMainProps> = ({
  onClose,
}) => {
  return (
    <ModalLayout
