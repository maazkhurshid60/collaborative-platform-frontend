  ...
  return (
    <div className="p-3 text-[14px] text-textGreyColor">
      ...
      {chatType !== "group" && (
        <>
          <p>
            Your Details and any messages you add after sharing stay private.
            You will need to update the link after adding more message to this
            chat.
          </p>
          <div className="mt-5 flex items-center justify-baseline gap-x-3">
            ...
            <button
              type="button"
              onClick={() => setGeneratedUrl(getChatLink())}
              className="h-10 px-5 rounded-lg bg-primaryColorDark cursor-pointer text-white text-[13px] font-semibold hover:bg-opacity-90 transition-all shrink-0"
            >
              Create
            </button>
          </div>
