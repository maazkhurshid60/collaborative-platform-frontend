                ...
                >
                    ...
                    <div className="mb-6 mt-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="116" height="116" viewBox="0 0 116 116" fill="none">
                            ...
                            <defs>
                                <filter id="filter0_d_2964_3244" x="4.51101" y="6.97028" width="107.202" height="107.202" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <p className="text-[16px] text-[#667085] font-normal font-[Poppins] mb-8 text-center max-w-[340px]">
