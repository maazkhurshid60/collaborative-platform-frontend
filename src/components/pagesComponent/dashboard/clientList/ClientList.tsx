...
const ClientList = () => {
    ...
    const handleDeleteFun = (id: string, providerId: string, isCreator: boolean) => {
                                            ...
                                            <div className="flex items-center justify-start gap-x-2 h-full">
                                                {(
                                                    ...
                                                    <>
                                                        ...
                                                        <DeleteIcon onClick={() => {
                                                            const isCreator = data?.createdByProviderId === loginUserId?.user?.id ||
                                                                data?.createdByProviderId === loginUserId?.id ||
                                                                loginUserId?.user?.role === "superAdmin";
                                                            handleDeleteFun(data?.id ?? "", loginUserId?.user?.id, isCreator);
                                                        }} />
                                                    </>
                                                ) : (
                                                    <>
