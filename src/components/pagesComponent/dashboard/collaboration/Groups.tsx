...
const Groups: React.FC<GroupsProps> = ({ data, onClick }) => {
    ...
    return (
        <div className="overflow-x-hidden">
            <NavLink to={`/chat/group/${data?.id}`} className='mb-4 pb-2 pt-2 pl-2 flex items-center gap-x-2 border-b-[1px] border-b-solid border-b-textGreyColor/30 hover:bg-primaryColorLight transition-all duration-300 cursor-pointer hover:rounded-md hover:border-b-primaryColorLight'>
