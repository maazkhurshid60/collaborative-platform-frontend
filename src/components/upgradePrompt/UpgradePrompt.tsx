...
const UpgradePrompt: React.FC<UpgradePromptProps> = ({
    ...
    if (showFullScreen) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                <div className="max-w-md w-full bg-white rounded-[16px] shadow-lg p-8 text-center">
                    ...
                    <button
                        ...
                        className="w-full bg-[#2C9993] text-white py-3 px-6 rounded-[12px] font-semibold hover:bg-[#237c76] transition-colors"
                    >
                        View Plans
                    </button>
                </div>
    ...
    return (
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#ECFDF5] border border-[#2C9993] rounded-[8px]">
