...
const ClientSignup = () => {
  const licenseNoData = useSelector(
    (state: RootState) => state.LoginUserDetail.licenseNoResult,
  );
  ...
  useEffect(() => {
    ...
    if (licenseNoData?.gender) {
      setValue("gender", licenseNoData.gender.toLowerCase(), {
        shouldValidate: true,
      });
    }
        ...
        {isLicenseFound && (
          <div className="text-center mb-6">
            <p className="text-[#0d9488] font-medium text-sm bg-[#ccfbf1] p-3 rounded-md">
              Complete your account setup to access the documents shared with
              you.
            </p>
          </div>
        )}
          ...
          <form onSubmit={handleSubmit(signupFunction)}>
            ...
            <div className="mb-3.5">
              ...
              <p className="text-xs text-gray-500 mt-1 leading-tight">
                Min 10 chars, including 1 uppercase, 1 lowercase, 1 number, and
                1 special character.
              </p>
            </div>
            <div className="mb-3.5">
            ...
            <div className="mt-4 mb-2">
              ...
              >
                ...
                <span className="text-sm text-gray-600 leading-relaxed select-none">
                  ...
                  . I understand my obligations regarding protected health
                  information (PHI).
                </span>
              </label>
              {errors.hipaaConsent && (
            ...
            <p className="font-normal labelNormal text-center mt-8">
              ...
              <span
                className="capitalize ml-1 text-greenColor underline font-bold cursor-pointer"
                onClick={() => {
                  navigate("/");
                  dispatch(emptyResult());
                }}
              ...
              or
              <span
                className="capitalize text-greenColor underline font-bold cursor-pointer ml-1"
                onClick={() => {
                  navigate("/signup-with-client-id");
                  dispatch(emptyResult());
                }}
              >
                {" "}
