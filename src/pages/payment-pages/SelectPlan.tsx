...
const SelectPlan = () => {
    ...
    const plans = [
        ...
        },
        {
            name: 'Premium',
            monthlyPrice: '199',
            annualPrice: '159', // Example: ~20% discount
    ...
    return (
        <div className="min-h-screen bg-[#F9FAFB] flex flex-col items-center py-10 px-4 font-[Poppins]">
            ...
            <div className="w-full max-w-[1320px] flex flex-col">
                ...
                <div className="flex flex-col items-center mt-12">
                    ...
                    {/* Pricing Grid */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full mb-20 px-5">
                        {plans.map((plan, index) => (
                            ...
                            >
                                ...
                                {/* Action Button */}
                                <button
                                    onClick={() => plan.name === 'Free' && navigate('/confirm-free-account')}
                    ...
                    {/* Back Button Section */}
                    <div className="w-full flex justify-start mb-16 px-4">
                        <button
                            onClick={() => navigate(-1)}
