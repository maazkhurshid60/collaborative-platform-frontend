  ...
  const plans = [
    {
      ...
      // Free plan is available indefinitely
      // Show "Start for Free" for users who are not subscribed
      // Show "Upgrade" when moving to a paid plan
        ...
        <div className="w-full max-w-330 flex flex-col">
          ...
          <div className="flex flex-col items-center mt-4">
              ...
              {plans
                ...
                .map((plan, index) => (
                  ...
                  >
                    ...
                    {/* Features List */}
                    <div
                      className={` mt-auto p-4 rounded-2xl ${plan.theme === "pro" ? "" : "bg-inputBgColor"}`}
                    >
                      <ul className="space-y-2">
                        {plan.features.map((feature, i) => (
                          <li key={i} className="flex items-start gap-2">
                            ...
                            <span
                              className={`text-[12px] leading-snug ${plan.theme === "pro" ? "text-[#E5E7EB]" : "text-[#101828]"}`}
                            >
                              {feature}
                            </span>
                          </li>
            ...
            <div className="w-full flex justify-start mb-12 px-4">
              <button
                onClick={() => navigate(-1)}
                className="flex items-center gap-2 border-2 border-[#2C9993] text-[#2C9993] px-8 py-3 rounded-xl hover:bg-[#2C9993] hover:text-white transition-all cursor-pointer font-semibold shadow-sm"
              >
