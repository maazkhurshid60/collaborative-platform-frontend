...
const elements: {
...
}[] = [
  {
    type: "heading",
    label: "Section Title",
    icon: <Heading1 className="w-4 h-4 text-indigo-600" />,
    color: "hover:bg-indigo-50 hover:border-indigo-200",
  },
  {
    type: "provider-section",
  ...
  },
  {
    type: "paragraph",
    label: "Text Block",
    icon: <AlignLeft className="w-4 h-4 text-indigo-600" />,
    color: "hover:bg-indigo-50 hover:border-indigo-200",
  },
  {
    type: "list",
...
function ElementsPalette({ onAddField }: ElementsPaletteProps) {
  return (
