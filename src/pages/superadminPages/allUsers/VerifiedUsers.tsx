          ...
          <>
            <Table heading={heading}>
              {getCurrentRecords()?.map((data: User, id: number) => (
                <tr
                  key={id}
                  className={`border-b-[1px] border-b-solid border-b-lightGreyColor pb-4`}
                >
                  <td className="px-2 py-2 m-auto">
                    <div className="flex items-start gap-x-4">
                      ...
                      <div className="text-left">
                        ...
                        <p>
                          {(
                            data?.client?.email || data?.provider?.email
                          )?.toLowerCase()}
                        </p>
                      </div>
                    </div>
                  </td>
                  <td className="px-2 py-2 m-auto">{data?.licenseNo}</td>
    ...
    ${data.isApprove ? "bg-primaryColorDark/20" : "bg-inputBgColor"}`}
                  ...
                  <td className="py-2 h-full align-middle">
                    <div className="flex items-center justify-start gap-x-2 h-full">
                      <ViewIcon
                        onClick={() =>
                          navigate(`/verified-users/view-user/${data?.id}`)
                        }
                      />
                      <DeleteIcon
                        onClick={() => {
