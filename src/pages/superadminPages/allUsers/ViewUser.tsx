...
//   // ✅ Derive selected user from query data (no tooltip issues, no stale state)
...
//     <OutletLayout
//       heading="User profile"
//       // ✅ Back button in a normal flow position (no negative absolute positioning)
//       // ✅ Tooltip will not be clipped by header/sidebar overflow
//       backButton={
//         <div className="relative z-50">
//           <BackIcon onClick={() => navigate(-1)} />
//         </div>
...
//             label="Email"
//             data={
//               selectedUserData?.client?.email
//                 ? selectedUserData.client.email
//                 : selectedUserData?.provider?.email ?? "-"
//             }
//           />
...
//                   ?.filter((p: ProviderType) => p?.client?.clientShowToOthers === true)
